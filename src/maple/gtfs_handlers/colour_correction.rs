...
pub fn fix_background_colour_rgb_feed_route(
    ...
    match feed_id {
        ...
        "f-9q5b-longbeachtransit" => {
            let ugly_ass_grey = RGB::new(128, 130, 133);
            match route.id.as_str() {
                "1" | "2" | "4" | "8" => ugly_ass_grey,
                "21" | "22" => RGB::new(148, 6, 9),
                //passport
                "37" => RGB::new(214, 28, 41),
                "41" | "46" => RGB::new(220, 54, 32),
                ...
                "121" => RGB::new(0, 153, 208),
                "131" => ugly_ass_grey,
                "141" => ugly_ass_grey,
                "151" => ugly_ass_grey,
                "171" | "172" | "173" | "174" | "175" => RGB::new(116, 41, 142),
                "181" | "182" => ugly_ass_grey,
                "191" | "192" => RGB::new(0, 127, 62),
                "405" => ugly_ass_grey,
                _ => fix_background_colour_rgb(background),
            }
        }
