...
pub async fn ttarrivals_proxy(req: HttpRequest) -> impl Responder {
    ...
    let map_id = req.match_info().query("mapid");

    //https://lapi.transitchicago.com/api/1.0/ttarrivals.aspx?key=e325bc1ce4ad4ce0a3ad0830739c4993&mapid=40380&outputType=JSON
    let url = format!("https://lapi.transitchicago.com/api/1.0/ttarrivals.aspx?key=e325bc1ce4ad4ce0a3ad0830739c4993&mapid={}&outputType=JSON", map_id);
