use crate::map_coordinator::{
    AspenisedVehiclePositionOutput, BoundsInputV3, BulkFetchCoordinatorPool, ChateauUpdate,
...
use crate::{ClientMessage, MapViewportUpdate, ServerMessage, trajectories};
...
impl Actor for LiveLocationsWebSocket {
...
impl StreamHandler<Result<ws::Message, ws::ProtocolError>> for LiveLocationsWebSocket {
                ...
                match msg {
                    ...
                    _ => {
                        let msg = ServerMessage::Error {
                            message: "This endpoint only supports live locations (map/trajectory) updates.".to_string(),
                        };
...
impl Handler<MapBuildEvent> for LiveLocationsWebSocket {
    type Result = ();
...
impl Handler<ChateauUpdate> for LiveLocationsWebSocket {
    type Result = ();
